...
public class MatrixMultiplyTest extends TestCase {
    // Número de veces que se repetirá cada test, para tener resultados de tiempo
    // consistentes.
    ...
    /**
     * Crea un arreglo double[] de longitud N para utilizar como esntrada para cada
     * test.
     *
    ...
    /**
     * Una implementación de referencia para seqMatrixMultiply, en caso de que algun
     * de los archivos fuentes principales se maodificado accidentalmente.
     */
     ...
     * @return La mejora en la rapidez lograda, No todas pruebas utilizan esta
     *         información
     */
    private double parTestHelper(final int N) {
        ...
        // Utiliza una version secuencial de referencia para calcular el resultado
        // correcto
        ...
        /*
         * Ejecuta varias repeticiones de las versiones secuencial y paralela para
         * obtener una medición exacta del desempeño en paralelo
         */
    ...
    /**
     * Prueba el desempeño de la implementación paralela con una matriz de tamaño
     * 512x512.
     */
